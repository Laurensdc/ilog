...
{
	if (region.bc.aB === region.bt.aB)
	{
		return 'on line ' + region.bc.aB;
	}
	return 'on lines ' + region.bc.aB + ' through ' + region.bt.aB;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		$elm$core$Maybe$isJust(request.en) && _Http_track(router, xhr, request.en.a);

		try {
			xhr.open(request.dt, request.at, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {by: fragment, bF: host, bV: path, bX: port_, b$: protocol, b0: query};
	});
...
var $author$project$CallTypes$Call = F5(
	function (id, who, comments, when, isArchived) {
		return {cX: comments, bH: id, dp: isArchived, er: when, es: who};
	});
var $author$project$CallTypes$FromBackend = function (a) {
	return {$: 1, a: a};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {br: col, cZ: contextStack, bY: problem, b6: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.b6, s.br, x, s.c));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{br: col, c: s0.c, d: s0.d, dy: offset, b6: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.dy, s.b6, s.br, s);
	};
};
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.dy, s.a);
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{br: 1, c: s.c, d: s.d, dy: s.dy + 1, b6: s.b6 + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{br: s.br + 1, c: s.c, d: s.d, dy: newOffset, b6: s.b6, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.dy, s.b6, s.br, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{br: newCol, c: s.c, d: s.d, dy: newOffset, b6: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {br: col, bY: problem, b6: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.b6, p.br, p.bY);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{br: 1, c: _List_Nil, d: 1, dy: 0, b6: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Main$callDecoder = A6(
	...
	$author$project$CallTypes$Call,
	A2(
		$elm$json$Json$Decode$andThen,
		function (i) {
			return $elm$json$Json$Decode$succeed(
				$author$project$CallTypes$FromBackend(i));
		},
...
var $author$project$CallTypes$SubTask = F4(
	function (id, callId, text, done) {
		return {cP: callId, c2: done, bH: id, d4: text};
	});
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Main$subTaskDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$CallTypes$SubTask,
	A2(
		$elm$json$Json$Decode$andThen,
		function (id) {
			return $elm$json$Json$Decode$succeed(
				$author$project$CallTypes$FromBackend(id));
		},
		A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int)),
	A2(
		$elm$json$Json$Decode$andThen,
...
var $author$project$Main$callsAndSubTasksDecoder = A3(
	...
	F2(
		function (calls, subTasks) {
			return {k: calls, g: subTasks};
		}),
	$author$project$Main$callsDecoder,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cz: false, a0: r.a0, aA: r.aA, da: r.da, dt: r.dt, ej: r.ej, en: r.en, at: r.at}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{a0: $elm$http$Http$emptyBody, aA: r.aA, da: _List_Nil, dt: 'GET', ej: $elm$core$Maybe$Nothing, en: $elm$core$Maybe$Nothing, at: r.at});
};
var $author$project$Main$getCallsAndSubTasks = function (backendUrl) {
	return $elm$http$Http$get(
		{
			aA: A2($elm$http$Http$expectJson, $author$project$Main$GotCallsAndSubTasks, $author$project$Main$callsAndSubTasksDecoder),
			at: backendUrl + '/calls'
		});
};
...
var $author$project$Main$AddingCall = {$: 1};
var $author$project$CallTypes$Creating = {$: 0};
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'who',
								$elm$json$Json$Encode$string(call.es)),
								_Utils_Tuple2(
								'comments',
								$elm$json$Json$Encode$string(call.cX)),
								_Utils_Tuple2(
								'when',
								$elm$json$Json$Encode$int(
									$elm$time$Time$posixToMillis(call.er))),
								_Utils_Tuple2(
								'isArchived',
								$elm$json$Json$Encode$bool(call.dp)),
								_Utils_Tuple2(
								'subTasks',
								A2(
										...
										return $elm$json$Json$Encode$object(
											_List_fromArray(
												[
													_Utils_Tuple2(
													'text',
													$elm$json$Json$Encode$string(st.d4)),
													_Utils_Tuple2(
													'done',
		...
		return $elm$http$Http$request(
			{
				...
				aA: A2($elm$http$Http$expectJson, $author$project$Main$AddedCall, $author$project$Main$addedCallDecoder),
				da: _List_Nil,
				dt: 'PUT',
				ej: $elm$core$Maybe$Nothing,
				en: $elm$core$Maybe$Nothing,
				at: backendUrl + '/calls/add'
			});
	});
...
var $author$project$Main$archiveCall = F2(
	function (backendUrl, call) {
		...
		return $elm$http$Http$get(
			{
				aA: A2($elm$http$Http$expectJson, $author$project$Main$ArchivedCall, $author$project$Main$archivedCallDecoder),
				at: backendUrl + ('/calls/' + ($elm$core$String$fromInt(id) + '/archive'))
			});
	});
...
var $author$project$Main$toggleSubTask = F2(
	function (backendUrl, subTask) {
		...
		return $elm$http$Http$get(
			{
				aA: A2($elm$http$Http$expectJson, $author$project$Main$ToggledSubTask, $author$project$Main$toggledSubTaskDecoder),
				at: backendUrl + ('/subtasks/' + ($elm$core$String$fromInt(id) + '/done'))
			});
	});
...
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{a0: r.a0, aA: r.aA, da: _List_Nil, dt: 'POST', ej: $elm$core$Maybe$Nothing, en: $elm$core$Maybe$Nothing, at: r.at});
};
							...
							return $elm$json$Json$Encode$object(
								_List_fromArray(
									[
										...
										_Utils_Tuple2(
										'done',
										$elm$json$Json$Encode$bool(st.c2)),
										_Utils_Tuple2(
										'id',
		...
		return $elm$http$Http$post(
			{
				...
				aA: A2($elm$http$Http$expectJson, $author$project$Main$UpdatedCall, $author$project$Main$editedCallDecoder),
				at: backendUrl + ('/calls/' + ($elm$core$String$fromInt(id) + '/edit'))
			});
	});
		...
		switch (msg.$) {
					...
					_Utils_update(
						model,
						{
							...
							x: _Utils_ap(
								...
								_List_fromArray(
									[
										{cP: $author$project$CallTypes$Creating, c2: false, bH: $author$project$CallTypes$Creating, d4: model.Q}
									]))
						}),
					$elm$core$Platform$Cmd$none);
			case 5:
			...
			case 7:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{z: $author$project$Main$AddingCall}),
			...
			case 9:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							z: $author$project$Main$Editing(call),
							P: call.cX,
							Q: '',
							R: call.es,
							x: A2(
								$elm$core$List$filter,
								function (st) {
									return _Utils_eq(st.cP, call.bH);
								},
								model.g)
						}),
					$elm$core$Platform$Cmd$none);
			case 10:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{z: $author$project$Main$Closed, P: '', Q: '', R: '', x: _List_Nil}),
					$elm$core$Platform$Cmd$none);
			case 16:
			...
			case 14:
				...
				return _Utils_Tuple2(
					...
					A3(
						...
						model.ay,
						{cX: model.P, bH: $author$project$CallTypes$Creating, dp: false, er: time, es: model.R},
						A2(
							$elm$core$List$map,
							function (subTask) {
								return _Utils_update(
									subTask,
									{cP: $author$project$CallTypes$Creating});
							},
							model.x)));
			case 17:
				var httpResult = msg.a;
			...
			case 15:
				...
				return _Utils_Tuple2(
					model,
					A2($author$project$Main$toggleSubTask, model.ay, subTask));
			case 18:
				var httpResult = msg.a;
				if (!httpResult.$) {
						...
						_Utils_update(
							model,
							{
								g: A2(
									$elm$core$List$map,
									function (st) {
										return _Utils_eq(st.bH, subTask.bH) ? subTask : st;
									},
									model.g)
							}),
						$elm$core$Platform$Cmd$none);
			...
			case 6:
				...
				return _Utils_Tuple2(
					model,
					A2($author$project$Main$archiveCall, model.ay, call));
			case 19:
				var httpResult = msg.a;
				if (!httpResult.$) {
					var call = httpResult.a;
					var updatedCalls = call.dp ? A2(
						$elm$core$List$filter,
						function (c) {
							return !_Utils_eq(c.bH, call.bH);
						},
						model.k) : _Utils_ap(
						model.k,
						_List_fromArray(
							[call]));
					var updatedArchivedCalls = call.dp ? _Utils_ap(
						model.E,
						_List_fromArray(
							[call])) : A2(
						$elm$core$List$filter,
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{E: updatedArchivedCalls, k: updatedCalls}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = httpResult.a;
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 20:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{ag: true}),
					A3($author$project$Main$updateCall, model.ay, record.aa, record.g));
			default:
				var httpResult = msg.a;
				if (!httpResult.$) {
					var result = httpResult.a;
						...
						_Utils_update(
							model,
							{
								k: A2(
									$elm$core$List$map,
									function (c) {
										return _Utils_eq(result.aa.bH, c.bH) ? result.aa : c;
									},
									model.k),
								z: $author$project$Main$Closed,
								ag: false,
...
var $author$project$UiStuff$Accented = 4;
var $author$project$UiStuff$Bg = 2;
var $author$project$Main$OpenFormToAddCall = {$: 7};
var $mdgriffith$elm_ui$Internal$Model$Class = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $mdgriffith$elm_ui$Internal$Style$classes = {cp: 'a', aZ: 'atv', cr: 'ab', cs: 'cx', ct: 'cy', cu: 'acb', cv: 'accx', cw: 'accy', cx: 'acr', bl: 'al', bm: 'ar', cy: 'at', a_: 'ah', a$: 'av', cB: 's', cF: 'bh', cG: 'b', cI: 'w7', cK: 'bd', cL: 'bdt', aH: 'bn', cM: 'bs', aI: 'cpe', cT: 'cp', cU: 'cpx', cV: 'cpy', N: 'c', aK: 'ctr', aL: 'cb', aM: 'ccx', O: 'ccy', az: 'cl', aN: 'cr', cY: 'ct', c_: 'cptr', c$: 'ctxt', c7: 'fcs', bx: 'focus-within', c8: 'fs', c9: 'g', a2: 'hbh', a3: 'hc', bC: 'he', a4: 'hf', bD: 'hfp', dc: 'hv', de: 'ic', dg: 'fr', aQ: 'lbl', dj: 'iml', dk: 'imlf', dl: 'imlp', dm: 'implw', dn: 'it', dq: 'i', bN: 'lnk', aq: 'nb', bQ: 'notxt', dz: 'ol', dB: 'or', ai: 'oq', dG: 'oh', bT: 'pg', bU: 'p', dH: 'ppe', dK: 'ui', b6: 'r', dM: 'sb', dN: 'sbx', dO: 'sby', dP: 'sbt', dS: 'e', dU: 'cap', dV: 'sev', d0: 'sk', d4: 't', d5: 'tc', d6: 'w8', d7: 'w2', d8: 'w9', d9: 'tj', aX: 'tja', ea: 'tl', eb: 'w3', ec: 'w5', ed: 'w4', ee: 'tr', ef: 'w6', eg: 'w1', eh: 'tun', cf: 'ts', al: 'clr', eo: 'u', bg: 'wc', ck: 'we', bh: 'wf', cl: 'wfp', bi: 'wrp'};
...
var $author$project$UiStuff$Boom = 3;
var $author$project$UiStuff$Text = 0;
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.N);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c9);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bT);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bU);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b6);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.F)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dW.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dW.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.b6) + ('-' + ($elm$core$String$fromInt(pos.br) + ('-' + ($elm$core$String$fromInt(pos.cj) + ('-' + $elm$core$String$fromInt(pos.bB)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.dT) + 'px'),
					$elm$core$Maybe$Just(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.al)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dc, $mdgriffith$elm_ui$Internal$Style$classes.ai)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.c7, $mdgriffith$elm_ui$Internal$Style$classes.al)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.c7, $mdgriffith$elm_ui$Internal$Style$classes.ai)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aZ, $mdgriffith$elm_ui$Internal$Style$classes.al)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aZ, $mdgriffith$elm_ui$Internal$Style$classes.ai)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cB) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b6) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cB) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cB) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b6) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cB) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aK) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aJ: closing, o: _List_Nil, V: _List_Nil, C: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								o: A2(
									$elm$core$List$cons,
									{aJ: '\n}', o: _List_Nil, V: props, C: '@supports (' + (prop + (':' + (value + (') {' + parent.C))))},
									rendered.o)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.C + ('{' + (renderValues(rule.V) + (rule.aJ + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.b6) + (' / ' + ($elm$core$String$fromInt(position.b6 + position.bB) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.br) + (' / ' + ($elm$core$String$fromInt(position.br + position.cj) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.b6) + ('-' + ($elm$core$String$fromInt(position.br) + ('-' + ($elm$core$String$fromInt(position.cj) + ('-' + $elm$core$String$fromInt(position.bB)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dU + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.d4 + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.dU + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.d4)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bB: height / size, dT: size, ch: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cQ, adjustment.cE, adjustment.c0, adjustment.dr]);
	var lineHeight = 1.5;
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cB, $mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.aK, $mdgriffith$elm_ui$Internal$Style$classes.O, $mdgriffith$elm_ui$Internal$Style$classes.cx])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cB, $mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.aK, $mdgriffith$elm_ui$Internal$Style$classes.O, $mdgriffith$elm_ui$Internal$Style$classes.cv])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cB, $mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.aK, $mdgriffith$elm_ui$Internal$Style$classes.cw])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cB, $mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.aK, $mdgriffith$elm_ui$Internal$Style$classes.cu])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.d4 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a3)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.cB + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.d4 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bh + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a4)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.cp]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.cG]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.dB]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.dz]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.dg]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.cF]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.a_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bl);
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.cB + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.N + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.cB + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.b6 + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aM + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.O + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dP + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bQ)))))),
						A2(
							$elm$core$List$cons,
...
var $author$project$UiStuff$color = function (col) {
	switch (col) {
		case 0:
			return A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255);
		case 1:
			return A3($mdgriffith$elm_ui$Element$rgb255, 34, 34, 34);
		case 2:
			return A3($mdgriffith$elm_ui$Element$rgb255, 32, 32, 58);
		case 3:
			return A3($mdgriffith$elm_ui$Element$rgb255, 176, 42, 176);
		default:
			return A3($mdgriffith$elm_ui$Element$rgb255, 96, 32, 128);
	}
};
var $mdgriffith$elm_ui$Element$fromRgb = function (clr) {
	return A4($mdgriffith$elm_ui$Internal$Model$Rgba, clr.ar, clr.ap, clr.an, clr.ax);
};
var $mdgriffith$elm_ui$Element$toRgb = function (_v0) {
	...
	var b = _v0.c;
	var a = _v0.d;
	return {ax: a, an: b, ap: g, ar: r};
};
var $author$project$UiStuff$darken = function (col) {
	var rgb = $mdgriffith$elm_ui$Element$toRgb(col);
	var factor = 0.85;
	return $mdgriffith$elm_ui$Element$fromRgb(
		{ax: rgb.ax, an: rgb.an * factor, ap: rgb.ap * factor, ar: rgb.ar * factor});
};
...
var $author$project$UiStuff$smoothTransition = $mdgriffith$elm_ui$Element$htmlAttribute(
	A2($elm$html$Html$Attributes$style, 'transition', '0.15s ease-in-out'));
var $mdgriffith$elm_ui$Element$text = function (content) {
	return $mdgriffith$elm_ui$Internal$Model$Text(content);
};
var $author$project$UiStuff$button = F2(
	function (label, onPressMsg) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color(
					$author$project$UiStuff$color(3)),
					$mdgriffith$elm_ui$Element$Border$rounded(6),
					A2($mdgriffith$elm_ui$Element$paddingXY, 32, 8),
					$mdgriffith$elm_ui$Element$Font$color(
					$author$project$UiStuff$color(0)),
					$mdgriffith$elm_ui$Element$mouseOver(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							$author$project$UiStuff$darken(
								$author$project$UiStuff$color(3)))
						])),
					$author$project$UiStuff$smoothTransition
				]),
			{
				aR: $mdgriffith$elm_ui$Element$text(label),
				dA: $elm$core$Maybe$Just(onPressMsg)
			});
	});
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.az)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $mdgriffith$elm_ui$Element$Font$light = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.eb);
...
var $author$project$Main$fontGlobals = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$family(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$external(
				{dw: 'Open Sans', at: 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,600;0,700;1,300;1,400&family=Ubuntu:ital,wght@0,400;0,700;1,400;1,500&display=swap'}),
...
var $mdgriffith$elm_ui$Element$Font$regular = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.ed);
var $author$project$UiStuff$h2Styles = _List_fromArray(
	[
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{c7: $elm$core$Maybe$Nothing, dc: $elm$core$Maybe$Nothing, du: $elm$core$Maybe$Nothing},
			options));
};
...
var $author$project$UiStuff$noAttr = $mdgriffith$elm_ui$Element$htmlAttribute(
	$elm$html$Html$Attributes$class(''));
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.az + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.O)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $mdgriffith$elm_ui$Element$Font$alignLeft = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.ea);
...
var $lemol$ant_design_icons_elm$Ant$Icons$Svg$BorderOutlined$viewWithAttributes = function (attributes) {
	return A2(
		$elm$svg$Svg$svg,
		_Utils_ap(
			_List_fromArray(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M880 112H144c-17.7 0-32 14.3-32 32v736c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V144c0-17.7-14.3-32-32-32zm-40 728H184V184h656v656z')
					]),
				_List_Nil)
			]));
};
var $lemol$ant_design_icons_elm$Ant$Icons$Svg$borderOutlined = $lemol$ant_design_icons_elm$Ant$Icons$Svg$BorderOutlined$viewWithAttributes;
var $elm$svg$Svg$Attributes$fill = _VirtualDom_attribute('fill');
var $lemol$ant_design_icons_elm_ui$Ant$Icon$defaultProps = {aO: $elm$core$Maybe$Nothing, bB: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, aW: false, be: _List_Nil, bf: $elm$core$Maybe$Nothing, cj: $elm$core$Maybe$Nothing};
	...
	function (theme, attrs, svgIcon) {
		...
		var rotate_ = A2(
			...
			A2(
				...
				A2($elm$core$Maybe$map, $mdgriffith$elm_ui$Element$rotate, props.aU)));
		var spin_ = props.aW ? _List_fromArray(
			[
		...
		var svgAttributes = _Utils_ap(
			...
			spin_);
		var width_ = A2($elm$core$Maybe$withDefault, 1 * 14, props.cj);
		var height_ = A2($elm$core$Maybe$withDefault, 1 * 14, props.cj);
		var fill_ = A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2(
				$elm$core$Maybe$map,
				$elm$core$List$singleton,
				A2($elm$core$Maybe$map, $mdgriffith$elm_ui$Element$Font$color, props.aO)));
...
var $lemol$ant_design_icons_elm_ui$Ant$Icon$icon = $lemol$ant_design_icons_elm_ui$Ant$Icon$iconBase(
	{});
var $lemol$ant_design_icons_elm_ui$Ant$Icons$borderOutlined = function (attrs) {
	return A2($lemol$ant_design_icons_elm_ui$Ant$Icon$icon, attrs, $lemol$ant_design_icons_elm$Ant$Icons$Svg$borderOutlined);
};
...
var $author$project$UiStuff$iconsize = $lemol$ant_design_icons_elm_ui$Ant$Icon$width(24);
...
var $author$project$UiStuff$lighten = function (col) {
	var rgb = $mdgriffith$elm_ui$Element$toRgb(col);
	var factor = 1.15;
	return $mdgriffith$elm_ui$Element$fromRgb(
		{ax: rgb.ax * factor, an: rgb.an * factor, ap: rgb.ap * factor, ar: rgb.ar * factor});
};
...
var $mdgriffith$elm_ui$Element$Font$semiBold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.ef);
...
var $author$project$TimeStuff$toDutchWeekday = F2(
	function (zone, posix) {
		var day = A2($elm$time$Time$toWeekday, zone, posix);
		switch (day) {
			case 0:
				return 'Maandag';
			case 1:
...
var $mdgriffith$elm_ui$Element$Font$strike = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.d0);
var $author$project$Main$viewSubTasks = F2(
	function (call, subtasks) {
		var filteredSubTasks = A2(
			$elm$core$List$filter,
			function (subTask) {
				return _Utils_eq(subTask.cP, call.bH) ? true : false;
			},
			subtasks);
		return A2(
			$elm$core$List$map,
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$author$project$Main$ToggleSubTask(subTask)),
							$mdgriffith$elm_ui$Element$pointer
						]),
					_List_fromArray(
						[
							...
							subTask.c2 ? $lemol$ant_design_icons_elm_ui$Ant$Icons$checkSquareFilled(
								_List_fromArray(
									[$author$project$UiStuff$iconsize])) : $lemol$ant_design_icons_elm_ui$Ant$Icons$borderOutlined(
								_List_fromArray(
									[$author$project$UiStuff$iconsize]))),
							subTask.c2 ? A2(
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text(subTask.d4)
								])) : A2(
							$mdgriffith$elm_ui$Element$paragraph,
							_List_Nil,
							_List_fromArray(
	...
	function (calls, subtasks, options) {
		var sortedCalls = A2(
			...
			F2(
				function (a, b) {
					return (_Utils_cmp(
						$elm$time$Time$posixToMillis(a.er),
						$elm$time$Time$posixToMillis(b.er)) > 0) ? 0 : 2;
				}),
			calls);
		var archivedStyles = options.J ? _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color(
				$author$project$UiStuff$darken(
					$author$project$UiStuff$darken(
						...
						_Utils_ap(
							...
							_List_fromArray(
								[
									...
									$author$project$UiStuff$lighten(
										$author$project$UiStuff$lighten(
											$author$project$UiStuff$color(2))))
								])),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										options.J ? $lemol$ant_design_icons_elm_ui$Ant$Icons$checkSquareFilled(
											_List_fromArray(
												[$author$project$UiStuff$iconsize])) : $lemol$ant_design_icons_elm_ui$Ant$Icons$borderOutlined(
											_List_fromArray(
												[$author$project$UiStuff$iconsize]))),
									...
									[
										...
										_List_fromArray(
											[
												...
												$mdgriffith$elm_ui$Element$text(call.es)),
												A2(
												$mdgriffith$elm_ui$Element$row,
												_List_fromArray(
												...
												_List_fromArray(
													[
														...
														$mdgriffith$elm_ui$Element$text(
															A2($author$project$TimeStuff$toDutchWeekday, options.e, call.er))),
														A2(
														$mdgriffith$elm_ui$Element$el,
														_List_Nil,
														$mdgriffith$elm_ui$Element$text(
															A2($author$project$TimeStuff$toHumanDate, options.e, call.er) + (' - ' + A2($author$project$TimeStuff$toHumanTime, options.e, call.er))))
													])),
												A2(
												$mdgriffith$elm_ui$Element$paragraph,
												_List_fromArray(
												...
												_List_fromArray(
													[
														$mdgriffith$elm_ui$Element$text(call.cX)
													]))
											]))
									])),
								A2(
...
var $author$project$Main$viewArchivedCalls = function (model) {
	return ($elm$core$List$length(model.E) > 0) ? A3(
		$author$project$Main$viewCalls,
		model.E,
		model.g,
		{J: true, e: model.e, m: model.m}) : $mdgriffith$elm_ui$Element$none;
};
var $author$project$Main$AddCall = {$: 13};
var $author$project$Main$AddPreSaveSubTask = {$: 4};
var $author$project$Main$CloseEditForm = {$: 10};
var $author$project$Main$CloseForm = {$: 8};
var $author$project$Main$InputCommentsChanged = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$InputSubTaskChanged = function (a) {
	return {$: 2, a: a};
};
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {L: -box.L, S: -box.S, W: -box.W, Y: -box.Y};
};
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			...
			A3(
				...
				{t: _List_Nil, f: _List_Nil, n: _List_Nil, b: _List_Nil, av: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.bQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dH)),
		...
		var inputElement = A4(
			...
			_Utils_ap(
				...
				_Utils_ap(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Input$value(textOptions.d4),
							$mdgriffith$elm_ui$Internal$Model$Attr(
									...
									function () {
										if (textOptions.d4 === '') {
											...
											if (_v1.$ === 1) {
												...
												return _List_fromArray(
													[
														A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, _List_Nil, textOptions.d4 === '')
													]);
											}
										} else {
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.dk)
															]),
														_List_fromArray(
															[
																$elm$html$Html$text(textOptions.d4 + '\u00A0')
															])))
												]);
										}
									}()))
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.t, textOptions.d4 === ''))
												]);
										}
									}()
									])))),
...
var $mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{y: $elm$core$Maybe$Nothing, D: multi.dX, r: $mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{aR: multi.aR, aS: multi.aS, aT: multi.aT, d4: multi.d4});
	});
...
var $author$project$UiStuff$onEnter = function (msg) {
...
var $author$project$UiStuff$TextInverted = 1;
var $author$project$UiStuff$textInputStyles = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$color(
		$author$project$UiStuff$color(1)),
...
var $lemol$ant_design_icons_elm$Ant$Icons$Svg$DeleteFilled$viewWithAttributes = function (attributes) {
	return A2(
		$elm$svg$Svg$svg,
		_Utils_ap(
			_List_fromArray(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M864 256H736v-80c0-35.3-28.7-64-64-64H352c-35.3 0-64 28.7-64 64v80H160c-17.7 0-32 14.3-32 32v32c0 4.4 3.6 8 8 8h60.4l24.7 523c1.6 34.1 29.8 61 63.9 61h454c34.2 0 62.3-26.8 63.9-61l24.7-523H888c4.4 0 8-3.6 8-8v-32c0-17.7-14.3-32-32-32zm-200 0H360v-72h304v72z')
					]),
				_List_Nil)
			]));
};
var $lemol$ant_design_icons_elm$Ant$Icons$Svg$deleteFilled = $lemol$ant_design_icons_elm$Ant$Icons$Svg$DeleteFilled$viewWithAttributes;
var $lemol$ant_design_icons_elm_ui$Ant$Icons$deleteFilled = function (attrs) {
	return A2($lemol$ant_design_icons_elm_ui$Ant$Icon$icon, attrs, $lemol$ant_design_icons_elm$Ant$Icons$Svg$deleteFilled);
};
var $author$project$Main$viewPreSaveSubTasks = function (model) {
	return A2(
		$elm$core$List$map,
		function (subTask) {
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Events$onClick(
								$author$project$Main$DeletePreSaveSubTask(subTask)),
								$mdgriffith$elm_ui$Element$pointer
							]),
						$lemol$ant_design_icons_elm_ui$Ant$Icons$deleteFilled(
							_List_fromArray(
								[$author$project$UiStuff$iconsize])))
					]));
		},
		...
		[
				...
				[
					...
					A2(
						...
						_List_fromArray(
							[
								...
								switch (_v0.$) {
									...
									default:
										return $author$project$UiStuff$noAttr;
								}
							}()
							]),
						$lemol$ant_design_icons_elm_ui$Ant$Icons$closeCircleOutlined(
							_List_fromArray(
								[
									$lemol$ant_design_icons_elm_ui$Ant$Icon$width(32)
								]))))
				])),
			A2(
			$mdgriffith$elm_ui$Element$Input$text,
			_Utils_ap(
				$author$project$UiStuff$textInputStyles,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width(
					...
					])),
			{
				aR: A2(
					...
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('Wie?')),
				aS: $author$project$Main$InputWhoChanged,
				aT: $elm$core$Maybe$Just(
					A2(
						$mdgriffith$elm_ui$Element$Input$placeholder,
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('Jef van de Carrefour'))),
				d4: model.R
			}),
			A2(
					...
					])),
			{
				...
				aS: $author$project$Main$InputCommentsChanged,
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								$author$project$UiStuff$onEnter($author$project$Main$AddPreSaveSubTask),
							...
							])),
					{
						...
						aS: $author$project$Main$InputSubTaskChanged,
						aT: $elm$core$Maybe$Just(
							A2(
								$mdgriffith$elm_ui$Element$Input$placeholder,
								_List_Nil,
...
var $author$project$Main$viewSearchCalls = function (model) {
	var search = $elm$core$String$toLower(model.af);
	var whoFound = function (call) {
		return A2(
			$elm$core$String$contains,
			search,
			$elm$core$String$toLower(call.es));
	};
	var dateFound = function (call) {
		return A2(
			...
			$elm$core$String$toLower(
				A2($author$project$TimeStuff$toDutchWeekday, model.e, call.er))) || (A2(
			$elm$core$String$contains,
			search,
			$elm$core$String$toLower(
				A2($author$project$TimeStuff$toHumanDate, model.e, call.er))) || A2(
			$elm$core$String$contains,
			search,
			$elm$core$String$toLower(
				A2($author$project$TimeStuff$toHumanTime, model.e, call.er))));
	};
	var commentFound = function (call) {
		return A2(
			$elm$core$String$contains,
			search,
			$elm$core$String$toLower(call.cX));
	};
	var filterer = function (call) {
		return whoFound(call) || (commentFound(call) || dateFound(call));
	};
	var foundArchivedCalls = A2($elm$core$List$filter, filterer, model.E);
	var foundCalls = A2($elm$core$List$filter, filterer, model.k);
	return (($elm$core$List$length(foundCalls) > 0) || ($elm$core$List$length(foundArchivedCalls) > 0)) ? A2(
		...
		_List_fromArray(
			[
				A2(
				$mdgriffith$elm_ui$Element$el,
				$author$project$UiStuff$h2Styles,
				$mdgriffith$elm_ui$Element$text('Zoekresultaten')),
				A3(
				$author$project$Main$viewCalls,
				foundCalls,
				model.g,
				{J: false, e: model.e, m: model.m}),
				A3(
				$author$project$Main$viewCalls,
				foundArchivedCalls,
				model.g,
				{J: true, e: model.e, m: model.m})
			])) : $mdgriffith$elm_ui$Element$none;
};
var $author$project$Main$InputSearchChanged = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Main$viewSearchbar = function (text) {
	return A2(
		...
		{
			aR: $mdgriffith$elm_ui$Element$Input$labelHidden('Zoeken'),
			aS: $author$project$Main$InputSearchChanged,
			aT: $elm$core$Maybe$Just(
				A2(
					$mdgriffith$elm_ui$Element$Input$placeholder,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('Zoek in gesprekken'))),
			d4: text
		});
};
...
var $waratuman$time_extra$Time$Extra$startOfWeek = F3(
	function (z, startingWeekday, t) {
		var t_ = $elm$time$Time$posixToMillis(
			A2($waratuman$time_extra$Time$Extra$startOfDay, z, t));
		var d_ = $waratuman$time_extra$Time$Extra$weekdayToInt(
			A2($elm$time$Time$toWeekday, z, t));
		var diff = A2(
			$elm$core$Basics$modBy,
			7,
			d_ - $waratuman$time_extra$Time$Extra$weekdayToInt(startingWeekday)) * $waratuman$time_extra$Time$Extra$msPerDay;
		return $elm$time$Time$millisToPosix(t_ - diff);
	});
var $author$project$Main$filterCallsBeforeThisWeek = F3(
	function (calls, zone, today) {
		var startOfWeekInt = $elm$time$Time$posixToMillis(
			A2(
				$waratuman$time_extra$Time$Extra$startOfDay,
				zone,
				A3($waratuman$time_extra$Time$Extra$startOfWeek, zone, 0, today)));
		return A2(
			$elm$core$List$filter,
			function (call) {
				var startOfCallDayInt = $elm$time$Time$posixToMillis(
					A2($waratuman$time_extra$Time$Extra$startOfDay, zone, call.er));
				return _Utils_cmp(startOfWeekInt, startOfCallDayInt) > 0;
			},
			calls);
	});
var $author$project$Main$filterCallsFromDay = F3(
	function (calls, zone, day) {
		return A2(
			$elm$core$List$filter,
			function (call) {
				return _Utils_eq(
					$elm$time$Time$posixToMillis(
						A2($waratuman$time_extra$Time$Extra$startOfDay, zone, day)),
					$elm$time$Time$posixToMillis(
						A2($waratuman$time_extra$Time$Extra$startOfDay, zone, call.er)));
			},
			calls);
	});
var $author$project$Main$filterCallsFromThisWeekButNotToday = F3(
	function (calls, zone, today) {
		var startOfWeekInt = $elm$time$Time$posixToMillis(
			A2(
				$waratuman$time_extra$Time$Extra$startOfDay,
				zone,
				A3($waratuman$time_extra$Time$Extra$startOfWeek, zone, 0, today)));
		var startOfTodayInt = $elm$time$Time$posixToMillis(
		...
		return A2(
			...
			function (call) {
				var startOfCallDayInt = $elm$time$Time$posixToMillis(
					A2($waratuman$time_extra$Time$Extra$startOfDay, zone, call.er));
				return (_Utils_cmp(startOfCallDayInt, startOfWeekInt) > -1) && (_Utils_cmp(startOfCallDayInt, startOfTodayInt) < 0);
			},
			calls);
	});
var $author$project$Main$viewUnarchivedCalls = function (model) {
	var callsToday = A3($author$project$Main$filterCallsFromDay, model.k, model.e, model.m);
	var viewCallsToday = A3(
		$author$project$Main$viewCalls,
		callsToday,
		model.g,
		{J: false, e: model.e, m: model.m});
	var callsThisWeek = A3($author$project$Main$filterCallsFromThisWeekButNotToday, model.k, model.e, model.m);
	var viewCallsThisWeek = A3(
		$author$project$Main$viewCalls,
		callsThisWeek,
		model.g,
		{J: false, e: model.e, m: model.m});
	var callsBeforeThisWeek = A3($author$project$Main$filterCallsBeforeThisWeek, model.k, model.e, model.m);
	var viewCallsBeforeThisWeek = A3(
		$author$project$Main$viewCalls,
		callsBeforeThisWeek,
		model.g,
		{J: false, e: model.e, m: model.m});
	return ($elm$core$List$length(model.k) > 0) ? A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
...
var $author$project$Main$view = function (model) {
	var spinnerIfVisible = model.ag ? $author$project$Main$viewSpinner : $author$project$UiStuff$noAttr;
	...
	return A3(
				...
				[
					$mdgriffith$elm_ui$Element$focusStyle(
					{
						...
						dR: $elm$core$Maybe$Just(
							{
								cH: 10,
								cW: $author$project$UiStuff$color(4),
								dy: _Utils_Tuple2(0, 0),
								dT: 3
							})
					})
		...
		_Utils_ap(
			$author$project$Main$fontGlobals,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color(
					$author$project$UiStuff$color(2)),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							A2($mdgriffith$elm_ui$Element$spacingXY, 32, 0)
						]),
					_List_fromArray(
						[
							A2(
							...
							$mdgriffith$elm_ui$Element$text('ILog')),
							$author$project$Main$viewSearchbar(model.af),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_Nil,
							A2($author$project$UiStuff$button, 'Gesprek toevoegen', $author$project$Main$OpenFormToAddCall))
						])),
					(model.af === '') ? $author$project$Main$viewUnarchivedCalls(model) : $mdgriffith$elm_ui$Element$none,
					(model.af === '') ? A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							($elm$core$List$length(model.E) > 0) ? A2(
							$mdgriffith$elm_ui$Element$el,
							$author$project$UiStuff$h2Styles,
							$mdgriffith$elm_ui$Element$text('Done!')) : $mdgriffith$elm_ui$Element$none,
							$author$project$Main$viewArchivedCalls(model)
						])) : $mdgriffith$elm_ui$Element$none,
					(model.af !== '') ? $author$project$Main$viewSearchCalls(model) : $mdgriffith$elm_ui$Element$none
				])));
};
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{di: $author$project$Main$init, d3: $author$project$Main$subscriptions, ep: $author$project$Main$update, eq: $author$project$Main$viewDocument});
