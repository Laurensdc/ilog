...
var $author$project$Main$getCallsAndSubTasks = function (backendUrl) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$GotCallsAndSubTasks, $author$project$Main$subTasksDecoder),
...
var $author$project$Main$Boom = {$: 'Boom'};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$color($author$project$Main$Boom)),
				...
				[
					$mdgriffith$elm_ui$Element$focusStyle(
					{
						...
						shadow: $elm$core$Maybe$Just(
							{
								blur: 10,
								color: $author$project$Main$color($author$project$Main$Accented),
								offset: _Utils_Tuple2(0, 0),
								size: 3
							})
					})
