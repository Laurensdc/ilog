...
var $author$project$Main$dummyCalls = _List_fromArray(
	[
		...
		id: $author$project$Main$FromBackend(1),
		when: $elm$time$Time$millisToPosix(1614191035000),
		who: 'Woe 24/02 19:24'
	},
		{
		comments: 'Wa een tang',
		id: $author$project$Main$FromBackend(2),
		when: $elm$time$Time$millisToPosix(1614093833000),
		who: '23/02 03:23'
	},
		{
		comments: 'Wdddd een tang',
		id: $author$project$Main$FromBackend(3),
		when: $elm$time$Time$millisToPosix(1614007433000),
		who: '22/02 03:23'
	},
		{
		comments: 'Ik ben epic',
		id: $author$project$Main$FromBackend(4),
		when: $elm$time$Time$millisToPosix(1613921033000),
		who: '21/02'
	},
		{
		comments: 'Soep',
		id: $author$project$Main$FromBackend(5),
		when: $elm$time$Time$millisToPosix(1614116005166),
...
var $author$project$Main$dummySubTasks = _List_fromArray(
	[
		{
		callId: $author$project$Main$FromBackend(1),
		done: false,
		text: 'Bel labo'
	},
		{
		...
		text: 'Check die stock'
	},
		{
		callId: $author$project$Main$FromBackend(2),
		done: false,
		text: 'Bel Cissy'
	},
		{
		...
		text: 'Dingske mailen met vraag'
	}
	]);
var $author$project$Main$GotCalls = function (a) {
	return {$: 'GotCalls', a: a};
};
...
var $author$project$Main$getCalls = function (backendUrl) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$GotCalls, $author$project$Main$callsDecoder),
	...
	return _Utils_Tuple2(
		{
			...
			calls: $author$project$Main$dummyCalls,
			formVisible: false,
			inputComments: '',
			inputSearch: '',
			inputSubTask: '',
			...
			subTasks: $author$project$Main$dummySubTasks,
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					$author$project$Main$getCalls('http://localhost:3000')
				])));
};
...
var $Orasund$elm_ui_widgets$Internal$Material$Button$baseButton = function (_v0) {
	return {
		content: {
			content: {
				icon: {
					ifActive: {color: $Orasund$elm_ui_widgets$Widget$Material$Color$gray, size: 18},
					ifDisabled: {color: $Orasund$elm_ui_widgets$Widget$Material$Color$gray, size: 18},
					otherwise: {color: $Orasund$elm_ui_widgets$Widget$Material$Color$gray, size: 18}
				},
				text: {
					...
					_List_fromArray(
						[
							...
							subTask.done ? A2(
								...
								{color: $avh4$elm_color$Color$lightGreen, size: 24}) : A2(
								$Orasund$elm_ui_widgets$Widget$Icon$materialIcons,
								$danmarcab$material_icons$Material$Icons$Toggle$check_box_outline_blank,
								{color: $avh4$elm_color$Color$lightGray, size: 24})),
							subTask.done ? A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							options.archived ? $mdgriffith$elm_ui$Element$Font$strike : $mdgriffith$elm_ui$Element$Font$regular
						]),
					_List_fromArray(
						[
							A2(
										...
										_List_fromArray(
											[
												...
												A2(
													$elm$core$List$filter,
													function (s) {
														return _Utils_eq(s.callId, call.id) ? true : false;
													},
													subtasks)) > 0) ? A2(
												$mdgriffith$elm_ui$Element$el,
												_List_fromArray(
				...
				_List_fromArray(
					[
						...
						A2(
							...
							{color: $avh4$elm_color$Color$lightRed, size: 24}))
					]));
		},
		model.preSaveSubTasks);
};
	...
	return _List_fromArray(
		[
			...
			$Orasund$elm_ui_widgets$Widget$Material$containedButton($Orasund$elm_ui_widgets$Widget$Material$darkPalette),
			{
				...
				onPress: $elm$core$Maybe$Just($author$project$Main$AddCall),
...
var $author$project$Main$viewUnarchivedCalls = function (model) {
	...
	var callsToday = A3(
		$author$project$Main$viewCalls,
		A3($author$project$Main$filterCallsFromDay, model.calls, model.timeZone, model.today),
		model.subTasks,
		{archived: false, timeZone: model.timeZone, today: model.today});
	var callsThisWeek = A3(
		$author$project$Main$viewCalls,
		A3($author$project$Main$filterCallsFromThisWeekButNotToday, model.calls, model.timeZone, model.today),
		model.subTasks,
		{archived: false, timeZone: model.timeZone, today: model.today});
	var callsBeforeThisWeek = A3(
		$author$project$Main$viewCalls,
		A3($author$project$Main$filterCallsBeforeThisWeek, model.calls, model.timeZone, model.today),
		model.subTasks,
		{archived: false, timeZone: model.timeZone, today: model.today});
					...
					_List_fromArray(
						[
							...
							A2(
								...
								{color: $avh4$elm_color$Color$lightGray, size: 40})),
							A2(
							$mdgriffith$elm_ui$Element$Input$text,
							_List_fromArray(
								[
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.Call":{"args":[],"type":"{ id : Main.CallId, who : String.String, comments : String.String, when : Time.Posix }"},"Main.SubTask":{"args":[],"type":"{ callId : Main.CallId, text : String.String, done : Basics.Bool }"},"Time.Era":{"args":[],"type":"{ start : Basics.Int, offset : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"InputWhoChanged":["String.String"],"InputCommentsChanged":["String.String"],"InputSubTaskChanged":["String.String"],"InputSearchChanged":["String.String"],"AddPreSaveSubTask":[],"AddCall":[],"AddCallWithTime":["Time.Posix"],"DeletePreSaveSubTask":["Main.SubTask"],"ToggleSubTask":["Main.SubTask"],"ArchiveCall":["Main.Call"],"OpenForm":[],"CloseForm":[],"GetTimeZone":["Time.Zone"],"SetToday":["Time.Posix"],"Receive":["Basics.Int"],"GotCalls":["Result.Result Http.Error (List.List Main.Call)"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Main.CallId":{"args":[],"tags":{"Creating":[],"FromBackend":["Basics.Int"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Time.Zone":{"args":[],"tags":{"Zone":["Basics.Int","List.List Time.Era"]}}}}})}});}(this));