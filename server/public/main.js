...
{
	if (region.bV.a4 === region.ce.a4)
	{
		return 'on line ' + region.bV.a4;
	}
	return 'on lines ' + region.bV.a4 + ' through ' + region.ce.a4;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eb: 'hidden', dI: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eb: 'mozHidden', dI: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eb: 'msHidden', dI: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eb: 'webkitHidden', dI: 'webkitvisibilitychange' }
		: { eb: 'hidden', dI: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ck: fragment, cq: host, cL: path, cN: port_, cR: protocol, cS: query};
	});
...
var $author$project$Main$dummyCalls = _List_fromArray(
	[
		...
		{
		U: 'Wa een tang',
		J: $author$project$Main$FromBackend(2),
		x: $elm$time$Time$millisToPosix(1614093833000),
		aa: '23/02 03:23'
	},
		{
		U: 'Wdddd een tang',
		J: $author$project$Main$FromBackend(3),
		x: $elm$time$Time$millisToPosix(1614007433000),
		aa: '22/02 03:23'
	},
		{
		U: 'Ik ben epic',
		J: $author$project$Main$FromBackend(4),
		x: $elm$time$Time$millisToPosix(1613921033000),
		aa: '21/02'
	},
		{
		U: 'Soep',
		J: $author$project$Main$FromBackend(5),
		x: $elm$time$Time$millisToPosix(1614116005166),
		aa: 'Dinsdag 23/02 22:33?'
	}
	]);
var $author$project$Main$dummySubTasks = _List_fromArray(
	[
		{
		T: $author$project$Main$FromBackend(1),
		I: false,
		s: 'Bel labo'
	},
		{
		...
		{
		T: $author$project$Main$FromBackend(2),
		I: false,
		s: 'Bel Cissy'
	},
		{
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			S: _List_Nil,
			u: $author$project$Main$dummyCalls,
			aM: false,
			ay: '',
			ah: '',
			az: '',
			...
			Z: _List_Nil,
			c_: _List_Nil,
			D: $author$project$Main$dummySubTasks,
			i: $elm$time$Time$utc,
		...
		switch (msg.$) {
			...
			case 3:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 4:
				return (model.az === '') ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							az: '',
							Z: _Utils_ap(
								...
								_List_fromArray(
									[
										{T: $author$project$Main$Creating, I: false, s: model.az}
									]))
						}),
					$elm$core$Platform$Cmd$none);
			case 5:
					...
					_Utils_update(
						model,
						{
							u: _Utils_ap(
								...
								_List_fromArray(
									[
										{U: model.ay, J: newCallId, x: time, aa: model.aQ}
									])),
							aM: false,
							ay: '',
							aQ: '',
			...
			case 9:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							S: A2($elm$core$List$member, call, model.S) ? A2(
								$elm$core$List$filter,
								function (fCall) {
									return !_Utils_eq(fCall, call);
								},
								model.S) : A2($elm$core$List$cons, call, model.S),
							u: A2($elm$core$List$member, call, model.u) ? A2(
								$elm$core$List$filter,
								function (fCall) {
									return !_Utils_eq(fCall, call);
								},
								model.u) : A2($elm$core$List$cons, call, model.u)
						}),
					$elm$core$Platform$Cmd$none);
			case 10:
				return _Utils_Tuple2(
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							ay: $elm$core$String$fromInt(txt)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$Bg = 2;
var $author$project$Main$CloseForm = {$: 11};
var $author$project$Main$InputSearchChanged = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$OpenForm = {$: 10};
...
var $mdgriffith$elm_ui$Internal$Style$classes = {dg: 'a', b0: 'atv', di: 'ab', dj: 'cx', dk: 'cy', dl: 'acb', dm: 'accx', dn: 'accy', $7: 'acr', b2: 'al', b3: 'ar', dp: 'at', bB: 'ah', bC: 'av', dr: 's', dw: 'bh', dx: 'b', dB: 'w7', dD: 'bd', dE: 'bdt', be: 'bn', dF: 'bs', bi: 'cpe', dL: 'cp', dM: 'cpx', dN: 'cpy', af: 'c', bl: 'ctr', bm: 'cb', bn: 'ccx', ag: 'ccy', a$: 'cl', bo: 'cr', dQ: 'ct', dS: 'cptr', dT: 'ctxt', d5: 'fcs', cj: 'focus-within', d6: 'fs', d8: 'g', bJ: 'hbh', bK: 'hc', co: 'he', bL: 'hf', cp: 'hfp', ec: 'hv', ef: 'ic', eh: 'fr', bp: 'lbl', ek: 'iml', el: 'imlf', em: 'imlp', en: 'implw', eo: 'it', er: 'i', cA: 'lnk', aR: 'nb', cE: 'notxt', eF: 'ol', eG: 'or', aB: 'oq', eN: 'oh', cJ: 'pg', cK: 'p', eO: 'ppe', eT: 'ui', cW: 'r', eW: 'sb', eX: 'sbx', eY: 'sby', eZ: 'sbt', e$: 'e', e0: 'cap', e1: 'sev', e6: 'sk', s: 't', fb: 'tc', fc: 'w8', fd: 'w2', fe: 'w9', ff: 'tj', bx: 'tja', fg: 'tl', fh: 'w3', fi: 'w5', fj: 'w4', fk: 'tr', fl: 'w6', fm: 'w1', fn: 'tun', c7: 'ts', aH: 'clr', fr: 'u', bX: 'wc', db: 'we', bY: 'wf', dc: 'wfp', bZ: 'wrp'};
...
var $mdgriffith$elm_ui$Element$Font$alignLeft = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.fg);
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.dr + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.af);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.dr + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.d8);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.dr + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cJ);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.dr + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cK);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.dr + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cW);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.dr + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.e$);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.bk)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.e2.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.e2.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.cW) + ('-' + ($elm$core$String$fromInt(pos.b9) + ('-' + ($elm$core$String$fromInt(pos.R) + ('-' + $elm$core$String$fromInt(pos.cn)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.eD.a) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.eD.b) + 'px'),
					$elm$core$Maybe$Just(
								...
								$mdgriffith$elm_ui$Internal$Model$formatBoxShadow(
									{
										...
										eD: A2(
											...
											A2($elm$core$Tuple$mapFirst, $elm$core$Basics$toFloat, shadow.eD)),
										aE: shadow.aE
									}));
						},
						focus.e_),
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.ec, $mdgriffith$elm_ui$Internal$Style$classes.aH)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.d5, $mdgriffith$elm_ui$Internal$Style$classes.aH)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.d5, $mdgriffith$elm_ui$Internal$Style$classes.aB)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.aH)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.b0, $mdgriffith$elm_ui$Internal$Style$classes.aB)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dr) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cW) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dr) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dr) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cW) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dr) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bl) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {bj: closing, q: _List_Nil, am: _List_Nil, O: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								q: A2(
									$elm$core$List$cons,
									{bj: '\n}', q: _List_Nil, am: props, O: '@supports (' + (prop + (':' + (value + (') {' + parent.O))))},
									rendered.q)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.O + ('{' + (renderValues(rule.am) + (rule.bj + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.cW) + (' / ' + ($elm$core$String$fromInt(position.cW + position.cn) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.b9) + (' / ' + ($elm$core$String$fromInt(position.b9 + position.R) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.cW) + ('-' + ($elm$core$String$fromInt(position.b9) + ('-' + ($elm$core$String$fromInt(position.R) + ('-' + $elm$core$String$fromInt(position.cn)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.e0 + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.s + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.e0 + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.s)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {cn: height / size, aE: size, c9: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.dG, adjustment.dv, adjustment.dY, adjustment.eu]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.dr + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.e$))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.e$, $mdgriffith$elm_ui$Internal$Style$classes.bl, $mdgriffith$elm_ui$Internal$Style$classes.ag, $mdgriffith$elm_ui$Internal$Style$classes.$7])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.e$, $mdgriffith$elm_ui$Internal$Style$classes.bl, $mdgriffith$elm_ui$Internal$Style$classes.ag, $mdgriffith$elm_ui$Internal$Style$classes.dm])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.e$, $mdgriffith$elm_ui$Internal$Style$classes.bl, $mdgriffith$elm_ui$Internal$Style$classes.dn])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.e$, $mdgriffith$elm_ui$Internal$Style$classes.bl, $mdgriffith$elm_ui$Internal$Style$classes.dl])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.dr + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.s + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bK)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.dr + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.s + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bL)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.e$, $mdgriffith$elm_ui$Internal$Style$classes.dg]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.e$, $mdgriffith$elm_ui$Internal$Style$classes.dx]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.e$, $mdgriffith$elm_ui$Internal$Style$classes.eG]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.e$, $mdgriffith$elm_ui$Internal$Style$classes.eF]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.e$, $mdgriffith$elm_ui$Internal$Style$classes.eh]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.e$, $mdgriffith$elm_ui$Internal$Style$classes.dw]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.bB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b2);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.bB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b3);
		default:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.dr + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.af + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.dr + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.cW + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.bn + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ag + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.eZ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cE)))))),
						A2(
							$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.a$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ag)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $Orasund$elm_ui_widgets$Internal$Button$button = F2(
	function (style, _v0) {
		...
		return A2(
			...
			_Utils_ap(
				style.bH,
				_Utils_eq(onPress, $elm$core$Maybe$Nothing) ? style.a3 : style.a5),
			{
				bq: A2(
					...
					_List_fromArray(
						[
							icon(
							_Utils_eq(onPress, $elm$core$Maybe$Nothing) ? style.b.b.cs.a3 : style.b.b.cs.a5),
							A2(
...
var $Orasund$elm_ui_widgets$Widget$Material$Color$dark = A3($avh4$elm_color$Color$rgb255, 50, 50, 50);
...
var $mdgriffith$elm_ui$Element$fromRgb = function (clr) {
	return A4($mdgriffith$elm_ui$Internal$Model$Rgba, clr.bR, clr.bI, clr.bE, clr.ar);
};
...
var $author$project$Main$color = function (col) {
	switch (col) {
		...
		case 1:
			return A3($mdgriffith$elm_ui$Element$rgb255, 51, 51, 51);
		default:
			return $Orasund$elm_ui_widgets$Widget$Material$Color$fromColor($Orasund$elm_ui_widgets$Widget$Material$Color$dark);
	}
};
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.dQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a$)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $Orasund$elm_ui_widgets$Widget$Material$Color$accessibleTextColor = function (color) {
	var l = 1 + ($avh4$elm_color$Color$toRgba(color).ar * ($noahzgordon$elm_color_extra$Color$Accessibility$luminance(color) - 1));
...
var $mdgriffith$elm_ui$Element$Font$semiBold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.fl);
...
var $Orasund$elm_ui_widgets$Widget$Material$Color$gray = A3($avh4$elm_color$Color$rgb255, 119, 119, 119);
...
var $Orasund$elm_ui_widgets$Internal$Material$Button$baseButton = function (_v0) {
	return {
		b: {
			b: {
				cs: {
					ee: {au: $Orasund$elm_ui_widgets$Widget$Material$Color$gray, aE: 18},
					a3: {au: $Orasund$elm_ui_widgets$Widget$Material$Color$gray, aE: 18},
					a5: {au: $Orasund$elm_ui_widgets$Widget$Material$Color$gray, aE: 18}
				},
				s: {
					dP: _List_fromArray(
...
var $avh4$elm_color$Color$fromRgba = function (components) {
	return A4($avh4$elm_color$Color$RgbaSpace, components.bR, components.bI, components.bE, components.ar);
};
	...
	return $elm$core$String$concat(
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.eD.a) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.eD.b) + 'px',
...
var $mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {dz: almostShade.dz, au: almostShade.au, cu: false, eD: almostShade.eD, aE: almostShade.aE};
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var $Orasund$elm_ui_widgets$Widget$Material$Color$shadow = function (_float) {
	return {
		dz: _float,
		au: A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 0.2),
		eD: _Utils_Tuple2(0, _float),
		aE: 0
	};
};
...
var $Orasund$elm_ui_widgets$Widget$Material$Color$fromCIELCH = A2(
	...
	function (_v0) {
		...
		var h = _v0.a2;
		return {
			b$: c * $elm$core$Basics$cos(h),
			b5: c * $elm$core$Basics$sin(h),
			X: l
		};
	},
...
var $noahzgordon$elm_color_extra$Color$Convert$colorToXyz = function (cl) {
	...
	var g = c(green);
	var r = c(red);
	return {dd: ((r * 0.4124) + (g * 0.3576)) + (b * 0.1805), de: ((r * 0.2126) + (g * 0.7152)) + (b * 7.22e-2), bc: ((r * 1.93e-2) + (g * 0.1192)) + (b * 0.9505)};
};
var $noahzgordon$elm_color_extra$Color$Convert$xyzToLab = function (_v0) {
	...
	var y_ = c(y / 100);
	var z_ = c(z / 108.883);
	return {b$: 500 * (x_ - y_), b5: 200 * (y_ - z_), X: (116 * y_) - 16};
};
...
var $Orasund$elm_ui_widgets$Widget$Material$Color$toCIELCH = A2(
	...
	function (_v0) {
		...
		return {
			...
			a2: A2($elm$core$Basics$atan2, b, a),
			X: l
		};
	});
var $Orasund$elm_ui_widgets$Widget$Material$Color$withShade = F3(
	function (c2, amount, c1) {
		var fun = F2(
			function (a, b) {
				return {a_: ((a.a_ * (1 - amount)) + (b.a_ * amount)) / 1, a2: ((a.a2 * (1 - amount)) + (b.a2 * amount)) / 1, X: ((a.X * (1 - amount)) + (b.X * amount)) / 1};
			});
		var alpha = $avh4$elm_color$Color$toRgba(c1).ar;
	...
	return {
		b: {
			b: {
				cs: {
					ee: {
						au: $Orasund$elm_ui_widgets$Widget$Material$Color$accessibleTextColor(palette._),
						aE: 18
					},
					a3: {au: $Orasund$elm_ui_widgets$Widget$Material$Color$gray, aE: 18},
					a5: {
			...
			A: _Utils_ap(
				$Orasund$elm_ui_widgets$Internal$Material$Button$baseButton(palette).b.A,
				_List_fromArray(
					[
		...
		bH: _Utils_ap(
			$Orasund$elm_ui_widgets$Internal$Material$Button$baseButton(palette).bH,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							$Orasund$elm_ui_widgets$Widget$Material$Color$fromColor(
								A3($Orasund$elm_ui_widgets$Widget$Material$Color$withShade, palette.o._, $Orasund$elm_ui_widgets$Widget$Material$Color$buttonPressedOpacity, palette._))),
							$mdgriffith$elm_ui$Element$Border$shadow(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							$Orasund$elm_ui_widgets$Widget$Material$Color$fromColor(
								A3($Orasund$elm_ui_widgets$Widget$Material$Color$withShade, palette.o._, $Orasund$elm_ui_widgets$Widget$Material$Color$buttonFocusOpacity, palette._))),
							$mdgriffith$elm_ui$Element$Border$shadow(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							$Orasund$elm_ui_widgets$Widget$Material$Color$fromColor(
								A3($Orasund$elm_ui_widgets$Widget$Material$Color$withShade, palette.o._, $Orasund$elm_ui_widgets$Widget$Material$Color$buttonHoverOpacity, palette._))),
							$mdgriffith$elm_ui$Element$Border$shadow(
							$Orasund$elm_ui_widgets$Widget$Material$Color$shadow(6))
						]))
				])),
		ee: _List_fromArray(
			[
				...
				$Orasund$elm_ui_widgets$Widget$Material$Color$fromColor(
					$Orasund$elm_ui_widgets$Widget$Material$Color$accessibleTextColor(palette._)))
			]),
		a3: _Utils_ap(
			$Orasund$elm_ui_widgets$Internal$Material$Button$baseButton(palette).a3,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color(
					$Orasund$elm_ui_widgets$Widget$Material$Color$fromColor(
						A2($Orasund$elm_ui_widgets$Widget$Material$Color$scaleOpacity, $Orasund$elm_ui_widgets$Widget$Material$Color$buttonDisabledOpacity, $Orasund$elm_ui_widgets$Widget$Material$Color$gray))),
					$mdgriffith$elm_ui$Element$Font$color(
					$Orasund$elm_ui_widgets$Widget$Material$Color$fromColor($Orasund$elm_ui_widgets$Widget$Material$Color$gray)),
					$mdgriffith$elm_ui$Element$Border$shadow(
		...
		a5: _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(
				$Orasund$elm_ui_widgets$Widget$Material$Color$fromColor(palette._)),
				$mdgriffith$elm_ui$Element$Font$color(
				$Orasund$elm_ui_widgets$Widget$Material$Color$fromColor(
					$Orasund$elm_ui_widgets$Widget$Material$Color$accessibleTextColor(palette._)))
			])
...
var $Orasund$elm_ui_widgets$Internal$Material$Palette$darkPalette = {
	aZ: A3($avh4$elm_color$Color$rgb255, 18, 18, 18),
	a1: A3($avh4$elm_color$Color$rgb255, 207, 102, 121),
	o: {
		aZ: A3($avh4$elm_color$Color$rgb255, 255, 255, 255),
		a1: A3($avh4$elm_color$Color$rgb255, 0, 0, 0),
		_: A3($avh4$elm_color$Color$rgb255, 0, 0, 0),
		a6: A3($avh4$elm_color$Color$rgb255, 0, 0, 0),
		f: A3($avh4$elm_color$Color$rgb255, 255, 255, 255)
	},
	_: A3($avh4$elm_color$Color$rgb255, 187, 134, 252),
	a6: A3($avh4$elm_color$Color$rgb255, 3, 218, 198),
	f: A3($avh4$elm_color$Color$rgb255, 18, 18, 18)
};
var $Orasund$elm_ui_widgets$Widget$Material$darkPalette = $Orasund$elm_ui_widgets$Internal$Material$Palette$darkPalette;
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				default:
					...
					if (_v6.$ === 1) {
						return _Utils_update(
							record,
							{
								ey: $elm$core$Maybe$Just(renderMode)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{d5: $elm$core$Maybe$Nothing, ec: $elm$core$Maybe$Nothing, ey: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.eT, $mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.e$]))),
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {ad: -box.ad, ai: -box.ai, an: -box.an, ap: -box.ap};
};
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			...
			A3(
				...
				{z: _List_Nil, h: _List_Nil, p: _List_Nil, c: _List_Nil, aX: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cE + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eO)),
		...
		var inputElement = A4(
			...
			_Utils_ap(
				...
				_Utils_ap(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Input$value(textOptions.s),
							$mdgriffith$elm_ui$Internal$Model$Attr(
					...
					_Utils_ap(
						(heightConstrained ? $elm$core$List$cons($mdgriffith$elm_ui$Element$scrollbarY) : $elm$core$Basics$identity)(
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
									A2($elm$core$List$any, $mdgriffith$elm_ui$Element$Input$hasFocusStyle, withDefaults) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cj),
									...
									function () {
										if (textOptions.s === '') {
											...
											if (_v1.$ === 1) {
												...
												return _List_fromArray(
													[
														A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, _List_Nil, textOptions.s === '')
													]);
											}
										} else {
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.el)
															]),
														_List_fromArray(
															[
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.z, textOptions.s === ''))
												]);
										}
									}()
									])))),
...
var $mdgriffith$elm_ui$Element$Font$italic = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.er);
...
var $mdgriffith$elm_ui$Element$Font$regular = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.fj);
var $elm$core$List$sortWith = _List_sortWith;
var $mdgriffith$elm_ui$Element$Font$strike = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.e6);
...
var $author$project$Main$viewSubTasks = F2(
	function (call, subtasks) {
		var filteredSubTasks = A2(
			$elm$core$List$filter,
			function (subTask) {
				return _Utils_eq(subTask.T, call.J) ? true : false;
			},
			subtasks);
		return A2(
			$elm$core$List$map,
					...
					_List_fromArray(
						[
							...
							subTask.I ? A2(
								...
								$danmarcab$material_icons$Material$Icons$Toggle$check_box,
								{au: $avh4$elm_color$Color$lightGreen, aE: 24}) : A2(
								$Orasund$elm_ui_widgets$Widget$Icon$materialIcons,
								$danmarcab$material_icons$Material$Icons$Toggle$check_box_outline_blank,
								{au: $avh4$elm_color$Color$lightGray, aE: 24})),
							subTask.I ? A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$strike]),
							$mdgriffith$elm_ui$Element$text(subTask.s)) : $mdgriffith$elm_ui$Element$text(subTask.s)
						]));
			},
			filteredSubTasks);
	});
	...
	function (calls, subtasks, options) {
		var sortedCalls = A2(
			...
			F2(
				function (a, b) {
					return (_Utils_cmp(
						$elm$time$Time$posixToMillis(a.x),
						$elm$time$Time$posixToMillis(b.x)) > 0) ? 0 : 2;
				}),
			calls);
		return A2(
			$elm$core$List$map,
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							options.ab ? $mdgriffith$elm_ui$Element$Font$strike : $mdgriffith$elm_ui$Element$Font$regular
						]),
					_List_fromArray(
						[
							A2(
										...
										[
											...
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$text(
														A2($author$project$Main$dateToHumanStr, options.i, call.x))),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
														[$mdgriffith$elm_ui$Element$Font$bold]),
													$mdgriffith$elm_ui$Element$text(call.aa))
												]))
										])),
									A2(
									$mdgriffith$elm_ui$Element$column,
										...
										_List_fromArray(
											[
												...
												A2(
													$elm$core$List$filter,
													function (s) {
														return _Utils_eq(s.T, call.J) ? true : false;
													},
													subtasks)) > 0) ? A2(
												$mdgriffith$elm_ui$Element$el,
												_List_fromArray(
													[
														$mdgriffith$elm_ui$Element$paddingEach(
														{ad: 0, ai: 0, an: 0, ap: 16})
													]),
												$mdgriffith$elm_ui$Element$text('Taken')) : $mdgriffith$elm_ui$Element$none
											]),
...
var $author$project$Main$viewArchivedCalls = function (model) {
	return ($elm$core$List$length(model.S) > 0) ? A2(
		$mdgriffith$elm_ui$Element$column,
		_List_Nil,
		_List_fromArray(
			[
				...
				A3(
					...
					model.S,
					model.D,
					{ab: true, i: model.i, m: model.m}))
			])) : $mdgriffith$elm_ui$Element$none;
};
var $author$project$Main$AddCall = {$: 5};
...
var $mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{G: $elm$core$Maybe$Nothing, P: multi.e3, w: $mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{bq: multi.bq, br: multi.br, bu: multi.bu, s: multi.s});
	});
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$paddingEach(
								{ad: 0, ai: 0, an: 16, ap: 0})
							]),
						$mdgriffith$elm_ui$Element$text(subTask.s)),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						A2(
							...
							{au: $avh4$elm_color$Color$lightRed, aE: 24}))
					]));
		},
		model.Z);
};
	...
	return _List_fromArray(
		[
				...
				]),
			{
				...
				br: $author$project$Main$InputWhoChanged,
				...
				]),
			{
				...
				br: $author$project$Main$InputCommentsChanged,
			...
			_List_fromArray(
				[
						...
						]),
					{
						...
						br: $author$project$Main$InputSubTaskChanged,
						bu: $elm$core$Maybe$Nothing,
						s: model.az
					})
				])),
			...
			$Orasund$elm_ui_widgets$Widget$Material$containedButton($Orasund$elm_ui_widgets$Widget$Material$darkPalette),
			{
				cs: $Orasund$elm_ui_widgets$Widget$Icon$materialIcons($danmarcab$material_icons$Material$Icons$Content$add),
				cG: $elm$core$Maybe$Just($author$project$Main$AddCall),
				s: 'Gesprek opslaan'
			})
		]);
};
var $author$project$Main$viewSearchCalls = function (model) {
	var search = $elm$core$String$toLower(model.ah);
	var filterer = function (call) {
		return (A2(
			$elm$core$String$contains,
			search,
			$elm$core$String$toLower(call.aa)) || (A2(
			$elm$core$String$contains,
			search,
			$elm$core$String$toLower(
				A2($author$project$Main$dateToHumanStr, model.i, call.x))) || A2(
			$elm$core$String$contains,
			search,
			$elm$core$String$toLower(call.U)))) ? true : false;
	};
	var foundArchivedCalls = A2($elm$core$List$filter, filterer, model.S);
	var foundCalls = A2($elm$core$List$filter, filterer, model.u);
		...
		return A2(
			...
			function (call) {
				var startOfCallDayInt = $elm$time$Time$posixToMillis(
					A2($waratuman$time_extra$Time$Extra$startOfDay, zone, call.x));
...
var $author$project$Main$viewUnarchivedCalls = function (model) {
	...
	var callsToday = A3(
		$author$project$Main$viewCalls,
		A3($author$project$Main$filterCallsFromDay, model.u, model.i, model.m),
		model.D,
		{ab: false, i: model.i, m: model.m});
	var callsThisWeek = A3(
		$author$project$Main$viewCalls,
		A3($author$project$Main$filterCallsFromThisWeekButNotToday, model.u, model.i, model.m),
		model.D,
		{ab: false, i: model.i, m: model.m});
	var callsBeforeThisWeek = A3(
		$author$project$Main$viewCalls,
		A3($author$project$Main$filterCallsBeforeThisWeek, model.u, model.i, model.m),
		model.D,
		{ab: false, i: model.i, m: model.m});
	return ($elm$core$List$length(model.u) > 0) ? A2(
		$mdgriffith$elm_ui$Element$column,
		_List_Nil,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text('Gesprekken / todo\'s')),
				($elm$core$List$length(callsToday) > 0) ? A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$Font$italic, topPadding]),
				$mdgriffith$elm_ui$Element$text('Vandaag')) : $mdgriffith$elm_ui$Element$none,
				A2($mdgriffith$elm_ui$Element$column, _List_Nil, callsToday),
				($elm$core$List$length(callsThisWeek) > 0) ? A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$Font$italic, topPadding]),
				$mdgriffith$elm_ui$Element$text('Eerder deze week')) : $mdgriffith$elm_ui$Element$none,
				A2($mdgriffith$elm_ui$Element$column, _List_Nil, callsThisWeek),
				($elm$core$List$length(callsBeforeThisWeek) > 0) ? A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$Font$italic, topPadding]),
				$mdgriffith$elm_ui$Element$text('Heel erg lang geleden...')) : $mdgriffith$elm_ui$Element$none,
				A2($mdgriffith$elm_ui$Element$column, _List_Nil, callsBeforeThisWeek)
			])) : $mdgriffith$elm_ui$Element$none;
};
var $avh4$elm_color$Color$white = A4($avh4$elm_color$Color$RgbaSpace, 255 / 255, 255 / 255, 255 / 255, 1.0);
var $author$project$Main$view = function (model) {
	var overlayFormIfVisible = model.aM ? $mdgriffith$elm_ui$Element$inFront(
		A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					...
					A2(
						...
						A2(
							...
							A2(
								...
								{au: $avh4$elm_color$Color$white, aE: 40})))),
					$mdgriffith$elm_ui$Element$behindContent(
					A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						{eB: 'Roboto', ft: 'https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&display=swap'})
					])),
					...
					_List_fromArray(
						[
							...
							A2(
								...
								{
									cs: $Orasund$elm_ui_widgets$Widget$Icon$materialIcons($danmarcab$material_icons$Material$Icons$Content$add),
									cG: $elm$core$Maybe$Just($author$project$Main$OpenForm),
									s: 'Gesprek toevoegen'
								})),
							A2(
							$mdgriffith$elm_ui$Element$el,
							...
							A2(
								...
								{au: $avh4$elm_color$Color$lightGray, aE: 40})),
							A2(
							$mdgriffith$elm_ui$Element$Input$text,
							_List_fromArray(
								[
							...
							{
								bq: $mdgriffith$elm_ui$Element$Input$labelHidden('Zoeken'),
								br: $author$project$Main$InputSearchChanged,
								bu: $elm$core$Maybe$Just(
									A2(
										$mdgriffith$elm_ui$Element$Input$placeholder,
										_List_Nil,
										$mdgriffith$elm_ui$Element$text('Zoeken: Klant, datum, commentaar, ...'))),
								s: model.ah
							})
						])),
					(model.ah === '') ? $author$project$Main$viewUnarchivedCalls(model) : $mdgriffith$elm_ui$Element$none,
					(model.ah === '') ? $author$project$Main$viewArchivedCalls(model) : $mdgriffith$elm_ui$Element$none,
					(model.ah !== '') ? $author$project$Main$viewSearchCalls(model) : $mdgriffith$elm_ui$Element$none
				])));
};
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{ej: $author$project$Main$init, e9: $author$project$Main$subscriptions, fs: $author$project$Main$update, fu: $author$project$Main$viewDocument});
